					...
					(this.setupElement = function (t) {
						...
						null === (n = r.element) ||
							...
							n.addEventListener("keydown", function (t) {
                                let centerX = r.element.getBoundingClientRect().left + r.element.getBoundingClientRect().width / 2;
                                let centerY = r.element.getBoundingClientRect().top + r.element.getBoundingClientRect().height / 2;
								if (t.key === "Enter") {
